...
class MustNotVerifyPasswordMiddlewareTest extends TestCase
{
  private SessionService $sessionService;
  private UserRepository $userRepository;
  private SessionRepository $sessionRepository;
  private VerificationUserRepository $verificationRepository;
  private MustNotVerifyPasswordMiddleware $middleware;
  ...
  function setUp(): void
  {
    ...
    $this->middleware = new MustNotVerifyPasswordMiddleware;
  ...
  function testBeforePasswordReset()
  {
  ...
  function testBeforeSendPasswordReset()
  {
    ...
    $this->middleware->before();
    $baseurl = BASE_URL;
    $this->expectOutputRegex("[$baseurl/users/password_reset/verify]");
  }
}
